...
{
    public partial class ValleyWindworks : MapsForm
    {

        public ValleyWindworks()
        {
            InitializeComponent();
        }
        ...
        private void Form_Load(object sender, EventArgs e)
        {
            ...
            CreateRouteConnectorButton(this, Player, "205", new Point(5, 277)); // connected to 205 on left
