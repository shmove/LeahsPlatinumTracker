...
namespace LeahsPlatinumTracker
{
    ...
    public class Tracker
    {
        ...
        /// </summary>
        /// <param name="_Game">The unique identifier of the game to load the tracker of.</param>
        public Tracker(string _Game)
        {
            Game = _Game;
            ...
            switch (Game)
            {
                case "PokemonPlatinum":
                    ...
                    VisualChecks = new PlatinumChecks();
                    ...
                    VisualMapSectors.Add(new VisualMapSector(this, "205", new List<MapSector>
                    {
                        new MapSector("205 S", 0, new List<Condition>
                        {
                            ...
                            new Condition("FuegoIronworks S", new PlatinumChecks(16)) // river can be surfed across
                        }),
                        new MapSector("205 C", 2, new List<Condition>
                        {
                            new Condition("205 S", new PlatinumChecks(16)), // river can be surfed across
                            new Condition("205 S", new PlatinumChecks(PlatinumChecks.CheckFlags.HasDefeatedWindworks)), // Two Grunts block the path until Mars is defeated in ValleyWindworks
                            new Condition("205 N", new PlatinumChecks(2)), // from the north, with cut
                        ...
                        new MapSector("205 N", 1, new List<Condition>
                        {
                            ...
                            new Condition("205 C", new PlatinumChecks(2)) // from the south, with cut
                        })
                    }, "Route 205"));
                    VisualMapSectors.Add(new VisualMapSector(this, "206", new List<MapSector>
                    {
                        ...
                        {
                            new Condition("207 N"),
                            new Condition("206 S B", new PlatinumChecks(2))
                        }),
                        new MapSector("206 S B", 2, new Condition("206 S A", new PlatinumChecks(2)))
                    ...
                    VisualMapSectors.Add(new VisualMapSector(this, "207", new List<MapSector>
                    {
                        ...
                        new MapSector("207 N", 1, new List<Condition> {
                            new Condition("207 S", new PlatinumChecks(PlatinumChecks.CheckFlags.HasBike)),
                    ...
                    VisualMapSectors.Add(new VisualMapSector(this, "210", new List<MapSector>
                    {
                        new MapSector("210 S", 1, new List<Condition> {
                            ...
                            new Condition("215"),
                            new Condition("210 N", new PlatinumChecks(PlatinumChecks.CheckFlags.HasSecretPotion)) // Psyduck block the path until given medicine
                        }),
                        new MapSector("210 N", 0, new List<Condition> {
                            new Condition("Celestic"),
                            new Condition("210 H"),
                            new Condition("210 S", new PlatinumChecks(PlatinumChecks.CheckFlags.HasSecretPotion)) // Psyduck block the path until given medicine
                        }),
                        new MapSector("210 H", 1, new Condition("210 N", new PlatinumChecks(64))) // House unreachable without rock climb
                    }, "Route 210"));
                    ...
                    VisualMapSectors.Add(new VisualMapSector(this, new MapSector("213", 3, new Condition("ValorLake Ext B", new PlatinumChecks(80))), "Route 213"));
                    ...
                    // MapSectors.Add(new MapSector("219/220", 0, new Condition(new PlatinumChecks(16)))); // ocean route, requires surf
                    VisualMapSectors.Add(new VisualMapSector(this, new MapSector("221", 2, new Condition("Sandgem", new PlatinumChecks(16), true)), "Route 221")); // via sandgem ocean route, requires surf
                    ...
                    //    new Condition("Sunyshore", new PlatinumChecks(16)), // Sunyshore via Surf
                    //    new Condition("PokeLeague S", new PlatinumChecks(144)) // PokeLeague S via Surf + Waterfall
                    // }));
                    // MapSectors.Add(new MapSector("224", 0)); // dead end (unless oak's letter?) -- Oak's letter does not create a new warp on this route
                    ...
                    VisualMapSectors.Add(new VisualMapSector(this, "226", new List<MapSector>
                    {
                        new MapSector("226 W", 0, new List<Condition> {
                            ...
                            new Condition("SurvivalArea B", new PlatinumChecks(64)), // house above SurvivalArea
                            new Condition("226 H", new PlatinumChecks(80)) // house island via surf + rock climb
                        }),
                        new MapSector("226 H", 1, new List<Condition> {
                            new Condition("226 W", new PlatinumChecks(80)), // 226 W via surf + rock climb
                            new Condition("226 E", new PlatinumChecks(16)) // 226 E via surf
                        }),
                        new MapSector("226 E", 1, new List<Condition> {
                            new Condition("226 H", new PlatinumChecks(16)), // 226 H via surf
                            new Condition("227 S")
                        })
                    }, "Route 226"));
                    VisualMapSectors.Add(new VisualMapSector(this, "227", new List<MapSector>
                    {
                        ...
                        new MapSector("227 C", 1, new List<Condition> {
                            new Condition("227 S", new PlatinumChecks(PlatinumChecks.CheckFlags.HasBike)),
                            new Condition("227 N", new PlatinumChecks(PlatinumChecks.CheckFlags.HasBike))
                        }),
                        new MapSector("227 N", 0, new List<Condition> {
                            new Condition("StarkMtn"),
                            new Condition("227 C", new PlatinumChecks(PlatinumChecks.CheckFlags.HasBike))
                        })
                    }, "Route 227"));
                    VisualMapSectors.Add(new VisualMapSector(this, "228", new List<MapSector>
                    {
                        new MapSector("228", 2, new List<Condition>
                        {
                            ...
                            new Condition("228 C", new PlatinumChecks(PlatinumChecks.CheckFlags.HasBike)) // riding up bike ramp from cave
                        }),
                        new MapSector("228 SW", 1, new Condition("228", new PlatinumChecks(PlatinumChecks.CheckFlags.HasBike))), // southwesterly section
                    ...
                    VisualMapSectors.Add(new VisualMapSector(this, "AcuityLake", new List<MapSector>
                    {
                        new MapSector("AcuityLake Ext S", 0, new List<Condition>
                        {
                            ...
                            new Condition("AcuityLake Ext N", new PlatinumChecks(64))
                        }),
                        new MapSector("AcuityLake Ext N", 1, new Condition("AcuityLake Ext S", new PlatinumChecks(64))),
                        new MapSector("AcuityLake Int A", 1, new Condition("AcuityLake Int B", new PlatinumChecks(16))),
                        new MapSector("AcuityLake Int B", 1, new Condition("AcuityLake Int A", new PlatinumChecks(16)))
                    }, "Acuity Lake"));
                    ...
                    VisualMapSectors.Add(new VisualMapSector(this, "Canalave", new List<MapSector>
                    {
                        new MapSector("Canalave", 9, new List<Condition>
                        {
                            ...
                            new Condition("Canalave Pokecentre", new PlatinumChecks(PlatinumChecks.CheckFlags.HasTeleport))
                        }),
                    ...
                    VisualMapSectors.Add(new VisualMapSector(this, "Celestic", new List<MapSector>
                    {
                        new MapSector("Celestic", 6, new List<Condition>
                        {
                            new Condition("210 N"),
                            new Condition("211 E"),
                            new Condition("Celestic Pokecentre", new PlatinumChecks(PlatinumChecks.CheckFlags.HasTeleport))
                        }),
                    ...
                    VisualMapSectors.Add(new VisualMapSector(this, "Eterna", new List<MapSector> {
                        ...
                        {
                            new Condition("TGEterna Ext", new PlatinumChecks(2)), // Accessible via TGEterna exit with Cut
                            new Condition("205 N"),
                            new Condition("211 W"),
                            new Condition("Eterna Pokecentre", new PlatinumChecks(PlatinumChecks.CheckFlags.HasTeleport))
                        }),
                        new MapSector("TGEterna Ext", 1, new Condition("Eterna", new PlatinumChecks(2))), // Accessible via Eterna with Cut
                        new MapSector("Eterna Pokecentre", 3)
                    }));
                    VisualMapSectors.Add(new VisualMapSector(this, "EternaForest", new List<MapSector>
                    {
                        new MapSector("EternaForest", 2, new Condition("EternaForest M", new PlatinumChecks(2))), // Accessible via Mansion w Cut
                        new MapSector("EternaForest M", 1, new Condition("EternaForest", new PlatinumChecks(2))) // vice versa
                    }, "Eterna Forest"));
                    ...
                    VisualMapSectors.Add(new VisualMapSector(this, "FightArea", new List<MapSector>
                    {
                        new MapSector("FightArea", 5, new List<Condition>
                        {
                            ...
                            new Condition("FightArea Pokecentre", new PlatinumChecks(PlatinumChecks.CheckFlags.HasTeleport))
                        }),
                    ...
                    VisualMapSectors.Add(new VisualMapSector(this, "Floaroma", new List<MapSector>
                    {
                        new MapSector("Floaroma", 6, new List<Condition>
                        {
                            new Condition("205 S"),
                            new Condition("204 N"),
                            new Condition("Floaroma Pokecentre", new PlatinumChecks(PlatinumChecks.CheckFlags.HasTeleport))
                        }),
                        new MapSector("Floaroma Pokecentre", 3)
                    }));
                    VisualMapSectors.Add(new VisualMapSector(this, "FuegoIronworks", new List<MapSector>
                    {
                        new MapSector("FuegoIronworks N", 1, new Condition("FuegoIronworks S", new PlatinumChecks(16))), // surf from FuegoIronworks S
                        new MapSector("FuegoIronworks S", 1, new List<Condition>
                        {
                            new Condition("FuegoIronworks N", new PlatinumChecks(16)), // river can be surfed across
                            new Condition("205 C", new PlatinumChecks(16)), // river can be surfed across
                            new Condition("205 S", new PlatinumChecks(16)) // river can be surfed across
                        })
                    }, "Fuego Ironworks"));
                    VisualMapSectors.Add(new VisualMapSector(this, "GalacticHQ", new List<MapSector>
                    {
                        new MapSector("GalacticHQ 1F A", 2, new Condition("GalacticHQ 1F B", new PlatinumChecks(PlatinumChecks.CheckFlags.HasGalacticKey))), // 1st floor, entrance section
                        new MapSector("GalacticHQ 1F B", 1, new Condition("GalacticHQ 1F A", new PlatinumChecks(PlatinumChecks.CheckFlags.HasGalacticKey))), // 1st floor, entrance section behind galactic door
                        ...
                        new MapSector("GalacticHQ 4F A", 1, new Condition("GalacticHQ 4F B", new PlatinumChecks(PlatinumChecks.CheckFlags.HasGalacticKey))), // room below Cyrus' room with stairs
                        new MapSector("GalacticHQ 4F B", 3, new Condition("GalacticHQ 4F A", new PlatinumChecks(PlatinumChecks.CheckFlags.HasGalacticKey))), // Cyrus' Room
                        new MapSector("GalacticHQ Warehouse B2F A", 2, new Condition("GalacticHQ Warehouse B2F B", new PlatinumChecks(PlatinumChecks.CheckFlags.HasGalacticKey))), // Southern section with 2 stairs
                        new MapSector("GalacticHQ Warehouse B2F B", 1, new Condition("GalacticHQ Warehouse B2F A", new PlatinumChecks(PlatinumChecks.CheckFlags.HasGalacticKey))) // Northern section with stairs
                    }, "Galactic HQ"));
                    VisualMapSectors.Add(new VisualMapSector(this, "Hearthome", new List<MapSector>
                    {
                        new MapSector("Hearthome A", 13, new List<Condition> // main Hearthome, can access from locked sections by walking through NPCs on entry
                        {
                            ...
                            new Condition("Hearthome Pokecentre", new PlatinumChecks(PlatinumChecks.CheckFlags.HasTeleport))
                        }),
                        new MapSector("Hearthome B", 1, new Condition("Hearthome A", new PlatinumChecks(PlatinumChecks.ProgressFlags.HasRelicBadge))), // bottom right - can access from main Hearthome w 3rd badge
                        new MapSector("Hearthome C", 1, new Condition("Hearthome A", new PlatinumChecks(PlatinumChecks.CheckFlags.HasSpokenFantina))), // gym - can access after speaking to fantina in contest hall
                    ...
                    VisualMapSectors.Add(new VisualMapSector(this, "Jubilife", new List<MapSector>
                    {
                        ...
                        new MapSector("Jubilife B", 2, new Condition("Jubilife A", new PlatinumChecks(PlatinumChecks.ProgressFlags.HasCoalBadge), true)), // bottom left, accessible with 1st badge
                    ...
                    {
                        new MapSector("MtCoronet 1F 1 A", 2, new Condition("MtCoronet 1F 1 B", new PlatinumChecks(64))), // Cyrus cutscene room, lower half - accessible via just rock climb and one way from upper half
                        new MapSector("MtCoronet 1F 1 B", 1, new Condition("MtCoronet 1F 1 A", new PlatinumChecks(80))), // Upper half, only accessible via surf and rock climb
                        new MapSector("MtCoronet Upper 1F 1 A", 1), // very bottom, not accessible but exitable with strength
                        new MapSector("MtCoronet Upper 1F 1 B", 1, new Condition("MtCoronet Upper 1F 1 C", new PlatinumChecks(32))), // leftmost entrance, accessible with only strength, can avoid RS check
                        new MapSector("MtCoronet Upper 1F 1 C", 1, new List<Condition> // rightmost entrance
                        {
                            new Condition("MtCoronet Upper 1F 1 A", new PlatinumChecks(32)), // accessible from A with strength
                            new Condition("MtCoronet Upper 1F 1 B", new PlatinumChecks(33)), // accessible from B with strength + rock smash
                            new Condition("MtCoronet Upper 1F 1 D", new PlatinumChecks(32)) // accessible from D with strength
                        }),
                        new MapSector("MtCoronet Upper 1F 1 D", 1, new Condition("MtCoronet Upper 1F 1 C", new PlatinumChecks(32))),
                        new MapSector("MtCoronet Upper 1F 2", 3), // self contained room with two cave exits and a set of stairs
                        new MapSector("MtCoronet 2F A", 2, new Condition("MtCoronet 2F B", new PlatinumChecks(32))), // broken boards cave room, leftmost warps
                        ...
                        new MapSector("MtCoronet 4F 1 A", 1, new Condition("MtCoronet 4F 1 C", new PlatinumChecks(64))), // MtCoronet room with a waterfall - leftmost entrance, only connected via rock climb
                        new MapSector("MtCoronet 4F 1 B", 1, new Condition("MtCoronet 4F 1 D", new PlatinumChecks(144))), // bottomright entrance, only connected via waterfall + surf
                        new MapSector("MtCoronet 4F 1 C", 1, new Condition("MtCoronet 4F 1 A", new PlatinumChecks(64))), // topright entrance, only connected to bottomleft via rock climb
                        new MapSector("MtCoronet 4F 1 D", 1, new Condition("MtCoronet 4F 1 B", new PlatinumChecks(144))), // top of waterfall, only connected to bottomright via waterfall+surf
                    }, "Mt. Coronet"));
                    VisualMapSectors.Add(new VisualMapSector(this, "MtCoronetPeak", new List<MapSector>
                    {
                        new MapSector("MtCoronetPeak A", 1, new Condition("MtCoronetPeak B", new PlatinumChecks(64))), // bottommost entrance, connects to middle sect via RC
                        new MapSector("MtCoronetPeak B", 2, new Condition("MtCoronetPeak A", new PlatinumChecks(64))), // middle section, accessed from below via RC
                        new MapSector("MtCoronetPeak C", 2, new Condition("MtCoronetPeak D", new PlatinumChecks(64))), // top right section, accessed from top via RC
                        new MapSector("MtCoronetPeak D", 1, new Condition("MtCoronetPeak C", new PlatinumChecks(64))) // topmost section, access from topright via RC
                    }, "Mt. Coronet Peak"));
                    ...
                    VisualMapSectors.Add(new VisualMapSector(this, "Oreburgh", new List<MapSector>
                    {
                        new MapSector("Oreburgh A", 11, new List<Condition> // Main area excluding blocked gym entrance
                        {
                            ...
                            new Condition("Oreburgh Pokecentre", new PlatinumChecks(PlatinumChecks.CheckFlags.HasTeleport))
                        }),
                        new MapSector("Oreburgh B", 1, new Condition("Oreburgh A", new PlatinumChecks(PlatinumChecks.CheckFlags.HasSpokenRoark))), // Gym is inaccessible until player has spoken to Roark (or done something else?)
                        new MapSector("Oreburgh Pokecentre", 3)
                    }));
                    VisualMapSectors.Add(new VisualMapSector(this, "OreburghGate", new List<MapSector>
                    {
                        new MapSector("OreburghGate A", 2, new Condition("OreburghGate B", new PlatinumChecks(1))),
                        new MapSector("OreburghGate B", 1, new Condition("OreburghGate A", new PlatinumChecks(1)))
                    }, "Oreburgh Gate"));
                    VisualMapSectors.Add(new VisualMapSector(this, "Pastoria", new List<MapSector>
                    {
                        ...
                        {
                            new Condition("212"),
                            new Condition("Pastoria Pokecentre", new PlatinumChecks(PlatinumChecks.CheckFlags.HasTeleport))
                        }),
                    ...
                    VisualMapSectors.Add(new VisualMapSector(this, "PokeLeague", new List<MapSector>
                    {
                        ...
                        {
                            new Condition("Sunyshore A", new PlatinumChecks(144)), // can surf here from sunyshore and waterfall up
                            new Condition("PokeLeague Pokecentre", new PlatinumChecks(PlatinumChecks.CheckFlags.HasTeleport)),
                            new Condition("PokeLeague Pokecentre", new PlatinumChecks(8)) // can fly here after unlocking the pokecentre?? why only these two places
                        }),
                        new MapSector("PokeLeague Ext N A", 1, new Condition("PokeLeague Ext N B", new PlatinumChecks(144))), // caveside, can surf down from league exit
                        new MapSector("PokeLeague Ext N B", 1, new List<Condition> // entrance to league, can surf up from caveside
                        {
                            new Condition("PokeLeague Ext N A", new PlatinumChecks(144)),
                            new Condition("PokeLeague Int", new PlatinumChecks(PlatinumChecks.CheckFlags.HasTeleport)),
                            new Condition("PokeLeague Int", new PlatinumChecks(8)) // can fly here after being inside?? why only these two places
                        }),
                    ...
                    VisualMapSectors.Add(new VisualMapSector(this, "Sandgem", new List<MapSector>
                    {
                        new MapSector("Sandgem", 4, new List<Condition>
                        {
                            ...
                            new Condition("221", new PlatinumChecks(16)),
                            new Condition("Sandgem Pokecentre", new PlatinumChecks(PlatinumChecks.CheckFlags.HasTeleport))
                        }, true),
                    ...
                    VisualMapSectors.Add(new VisualMapSector(this, "Snowpoint", new List<MapSector>
                    {
                        new MapSector("Snowpoint", 6, new List<Condition>
                        {
                            ...
                            new Condition("Snowpoint Pokecentre", new PlatinumChecks(PlatinumChecks.CheckFlags.HasTeleport))
                        }),
                    ...
                    VisualMapSectors.Add(new VisualMapSector(this, "Solaceon", new List<MapSector>
                    {
                        new MapSector("Solaceon", 8, new List<Condition>
                        {
                            new Condition("210 S"),
                            new Condition("209"),
                            new Condition("Solaceon Pokecentre", new PlatinumChecks(PlatinumChecks.CheckFlags.HasTeleport))
                        }),
                        new MapSector("Solaceon Pokecentre", 3)
                    }));
                    VisualMapSectors.Add(new VisualMapSector(this, "SendoffSpring", new List<MapSector>
                    {
                        new MapSector("SpringPath", 1, new Condition("214", new PlatinumChecks(PlatinumChecks.ProgressFlags.HasCynthia))), // how does this one work?
                        new MapSector("SendoffSpring S", 1, new Condition("SendoffSpring N", new PlatinumChecks(64))), // accessible from the north with RC
                        new MapSector("SendoffSpring N", 1, new Condition("SendoffSpring S", new PlatinumChecks(4160))) // vice versa + need completion
                    }, "Sendoff Spring"));
                    ...
                    VisualMapSectors.Add(new VisualMapSector(this, "Sunyshore", new List<MapSector>
                    {
                        ...
                        {
                            new Condition("Sunyshore B", new PlatinumChecks(64)), // rock climb house
                            new Condition("Sunyshore C"), // via gym exit, can walk through flint
                            new Condition("PokeLeague Ext S", new PlatinumChecks(144)), // surf and waterfall down from PokeLeague
                            new Condition("Sunyshore Pokecentre", new PlatinumChecks(PlatinumChecks.CheckFlags.HasTeleport))
                        }),
                        new MapSector("Sunyshore B", 1, new Condition("Sunyshore A", new PlatinumChecks(64))), // rock climb house
                        new MapSector("Sunyshore C", 1, new Condition("Sunyshore A", new PlatinumChecks(PlatinumChecks.CheckFlags.HasSpokenVolkner))), // gym
                    ...
                    VisualMapSectors.Add(new VisualMapSector(this, "SurvivalArea", new List<MapSector>
                    {
                        new MapSector("SurvivalArea A", 3, new List<Condition>
                        {
                            ...
                            new Condition("SurvivalArea Pokecentre", new PlatinumChecks(PlatinumChecks.CheckFlags.HasTeleport))
                        }),
                        new MapSector("SurvivalArea B", 1, new Condition("226 W", new PlatinumChecks(64))), // house above SurvivalArea, only accessible via RC from adjacent route
                    ...
                    VisualMapSectors.Add(new VisualMapSector(this, new MapSector("ValleyWindworks", 1, new Condition("205 S", new PlatinumChecks(PlatinumChecks.CheckFlags.HasWorksKey))), "Valley Windworks"));
                    VisualMapSectors.Add(new VisualMapSector(this, "ValorLake", new List<MapSector>
                    {
                        new MapSector("ValorLake Ext A", 7, new List<Condition> // main valor lakefront
                        {
                            new Condition("214"),
                            new Condition("222"),
                            new Condition("ValorLake Ext B", new PlatinumChecks(64)) // extra house (+ lower route) via RC
                        }),
                        new MapSector("ValorLake Ext B", 1, new List<Condition> // valor lakefront house
                        {
                            new Condition("ValorLake Ext A", new PlatinumChecks(64)), // via lakefront
                            new Condition("213", new PlatinumChecks(80)) // beach route via RC + surf
                        }),
                        new MapSector("ValorLake Int A", 1, new Condition("ValorLake Int B", new PlatinumChecks(16))),
                        new MapSector("ValorLake Int B", 1, new Condition("ValorLake Int A", new PlatinumChecks(16)))
                    }, "Valor Lake"));
                    VisualMapSectors.Add(new VisualMapSector(this, "Veilstone", new List<MapSector> // self contained
                    {
                        new MapSector("Veilstone", 15, new Condition("Veilstone Pokecentre", new PlatinumChecks(PlatinumChecks.CheckFlags.HasTeleport))),
                    ...
                    VisualMapSectors.Add(new VisualMapSector(this, "VerityLake", new List<MapSector>
                    {
                        ...
                        new MapSector("VerityLake Int A", 1, new Condition("VerityLake Int B", new PlatinumChecks(16))),
                        new MapSector("VerityLake Int B", 1, new Condition("VerityLake Int A", new PlatinumChecks(16)))
                    }, "Verity Lake"));
                    VisualMapSectors.Add(new VisualMapSector(this, "VictoryRoad", new List<MapSector>
                    {
                        new MapSector("VictoryRoad B1F A", 1, new Condition("VictoryRoad B1F B", new PlatinumChecks(16))), // Waterfall room, bottom entrance
                        new MapSector("VictoryRoad B1F B", 1, new List<Condition>
                        {
                            new Condition("VictoryRoad B1F A", new PlatinumChecks(16)), // from below with surf
                            new Condition("VictoryRoad B1F C") // from above with one-way
                        }), // middle entrance
                        new MapSector("VictoryRoad B1F C", 1, new Condition("VictoryRoad B1F B", new PlatinumChecks(144))), // top entrance

                        new MapSector("VictoryRoad 1F A", 1, new Condition("VictoryRoad 1F B", new PlatinumChecks(64))), // hell room in victory road - bottom entrance via RC from section B
                        new MapSector("VictoryRoad 1F B", 1, new List<Condition> // leftmid entrance + bottom section
                        {
                            new Condition("VictoryRoad 1F A", new PlatinumChecks(64)), // from section A with RC
                            new Condition("VictoryRoad 1F D") // via one-way
                        }),
                        new MapSector("VictoryRoad 1F C", 1, new Condition("VictoryRoad 1F D", new PlatinumChecks(64))), // leftbottom entrance via RC from section D
                        new MapSector("VictoryRoad 1F D", 1, new List<Condition> // mid section with stairs down
                        {
                            new Condition("VictoryRoad 1F C", new PlatinumChecks(64)), // via RC from section C
                        ...
                        {
                            new Condition("VictoryRoad 1F F", new PlatinumChecks(64)), // via RC from section F
                            new Condition("VictoryRoad 1F G", new PlatinumChecks(64)) // via RC from section G
                        }),
                        new MapSector("VictoryRoad 1F F", 1, new Condition("VictoryRoad 1F E", new PlatinumChecks(64))), // lefttop entrance - via RC from section E
                        new MapSector("VictoryRoad 1F G", 1, new Condition("VictoryRoad 1F E", new PlatinumChecks(64))) // topmost entrance - via RC from section E
                    }, "Victory Road"));
    ...
    public static class TrackerManager
    {
        ...
        public static Tracker FromJSON(string json)
        {
            ...
            try
            {
                ...
                tracker.VisualChecks = new PlatinumChecks();
